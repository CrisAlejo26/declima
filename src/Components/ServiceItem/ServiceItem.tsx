...
export const Service = ({ id, title, desc, img, link }: ServiceItem) => {
	return (
		<>
			<div className="col-lg-4 col-md-6">
				<div className="cs_service_card cs_style_1 text-center">
					<div className="cs_service_card_in">
						...
						<p className="cs_service_card_subtitle cs_mb_15">{desc}</p>
						<Link href={link} className="cs_service_card_icon cs_center">
