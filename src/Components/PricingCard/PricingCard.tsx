...
const PricingCard: React.FC<PricingCardProps> = ({ Price, Monthly, Title, FeatureList }) => {
	return (
		<div className="cs_pricing_plan cs_style_1">
			...
			<div className="cs_pricing_plan_head">
				<div className="cs_price">
					<div className="cs_price_in">
						<h3 className="cs_fs_36 cs_white_color cs_semibold">
							<span>$</span>
							{Price}
						</h3>
			...
			<Link href="/contact" className="cs_btn cs_style_1 cs_type_1 text-decoration-none">
