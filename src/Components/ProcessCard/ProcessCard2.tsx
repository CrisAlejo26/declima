...
const ProcessCard2: FC<ProcessCard2Props> = ({ Title, Content, Img }) => {
	return (
		<div className="cs_card cs_style_1 cs_type_1">
			<div className="cs_card_in cs_white_bg">
				...
				<Link
					href="/about"
					className="cs_text_btn cs_fs_14 text-uppercase cs_heading_color cs_bold cs_mb_30 text-decoration-none">
					READ MORE
					<svg
						width="14"
						height="14"
